# Category 6 authoritative catalog excerpt

Authoritative Category 6 content after the 10 question reduction.
Used for wording regression tests.

## Category 6: Family, Children & Parenting

### 1. What role would you ideally like extended family to have in your long term relationship?

**Format:** Family involvement range
...
**Alignment purpose:** Measures expectations for family closeness, couple autonomy, and extended family involvement.

### 2. Which boundaries with extended family are most important in a committed relationship?
...
**Priority follow up:** Of the boundaries you selected, which two allow the least room for compromise?

**Alignment purpose:** Identifies essential boundaries involving privacy, respect, money, time, parenting, and couple autonomy.

### 3. If a close family member needs substantial long term help, what level of responsibility should the couple generally assume?

**Format:** Support range

**Context note:** The appropriate level of support may depend on the family relationship, seriousness and duration of the need, available resources, other potential caregivers, and the effect on the couple or household.
...
**Alignment purpose:** Measures expectations surrounding family duty, caregiving, financial responsibility, shared decision making, and relational boundaries.

### 4. Which paths to building or expanding a family would you genuinely consider?
...
**Alignment purpose:** Identifies meaningful openness and limitations surrounding family formation without treating every pathway as interchangeable.

### 5. If biological children became difficult or impossible to have, how would you want the couple to proceed?
...
**Alignment purpose:** Surfaces potentially life defining expectations involving infertility, alternative family building paths, and non negotiable parenting goals.

### 6. How should parenting responsibilities generally be divided?
...
**Alignment purpose:** Identifies expectations for equality, roles, flexibility, and fairness in parenting labor.

### 7. Which principle should most strongly guide discipline and behavioral expectations for children?
...
**Alignment purpose:** Identifies the user's leading parenting principle without reducing parenting philosophy to a simplistic strict versus permissive scale.

### 8. When parents disagree about an important decision involving a child, what should happen?
...
**Alignment purpose:** Measures expectations for cooperation, expertise, experimentation, outside guidance, and mutual consent.

### 9. If a partner already has children, what role should a stepparent or long term partner generally have?

**Format:** Role range

**Context note:** The appropriate role must be shaped by custody arrangements, legal authority, co parenting agreements, the child's age and needs, the child's comfort, and the seriousness and stability of the relationship.
...
**Alignment purpose:** Measures expectations for stepparent involvement, caregiving, authority, gradual integration, and respect for existing family structures.

### 10. Which family or parenting differences would most seriously threaten long term compatibility?
...
**Alignment purpose:** Identifies high impact incompatibilities involving children, parenting, blended families, responsibility, and family boundaries.

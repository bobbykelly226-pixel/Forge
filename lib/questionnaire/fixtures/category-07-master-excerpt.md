# Category 7 authoritative catalog excerpt

Authoritative Category 7 content after the 10 question reduction.
Used for wording regression tests.

## Category 7: Faith, Spirituality & Worldview

### 1. Which description most closely reflects your current relationship with faith or spirituality?
...
**Alignment purpose:** Establishes the current role of faith or spirituality without treating religious and nonreligious identities as opposing moral categories.

### 2. Which religious, spiritual, or nonreligious tradition most closely reflects your current identity?

**Format:** Structured identity selection
...
**Alignment purpose:** Records self identified belief tradition without assuming that a label reveals practice, doctrine, values, or relationship expectations.

### 3. Which practices or expressions of faith, spirituality, or worldview are currently meaningful in your life?

**Format:** Select all that apply

**Implementation note:** This is an unrestricted multi select. An unselected practice does not automatically indicate opposition.
...
### 4. How important is it that your long term partner shares your religious, spiritual, or nonreligious beliefs?

**Format:** Importance scale

**Context note:** "Shared beliefs" may refer to a specific tradition, shared core convictions, or a compatible approach to faith and worldview. Later questions clarify which meaning applies to the user.
...
**Alignment purpose:** Measures the importance of belief similarity without assuming that all people within the same tradition are compatible.

### 5. Which areas would be most important for you and a partner to approach compatibly?

**Format:** Select up to five
...
**Priority follow up:** Of the areas you selected, which two allow the least room for compromise?

**Alignment purpose:** Identifies where belief compatibility matters in everyday and long term relationship decisions.

### 6. If you and your partner held different beliefs, what would you need for the relationship to remain healthy?

**Format:** Select up to four
...
**Priority follow up:** Of the conditions you selected, which two would be most necessary?

**Alignment purpose:** Measures what makes an interfaith or belief diverse relationship genuinely workable for the respondent.

### 7. How comfortable would you be if a long term partner's beliefs changed meaningfully during the relationship?

**Format:** Flexibility range

**Context note:** Comfort with a change may depend on whether it affects an essential belief, relationship commitment, household practice, expectations concerning children, or another important part of the shared life.

**Implementation note:** The contextual response no longer needs separate answer storage because it is now interpretive guidance rather than a selectable sixth position.
...
**Alignment purpose:** Measures adaptability when beliefs evolve without treating flexibility as inherently healthier or more mature than consistency.

### 8. When an important relationship decision conflicts with a religious, spiritual, or deeply held ethical belief, what should guide the couple most strongly?

**Format:** Scenario based choice
...
**Alignment purpose:** Examines how someone balances conviction, mutual consent, interpretation, guidance, and relationship consequences.

### 9. If children were part of the relationship, how should religion, spirituality, or nonreligious beliefs primarily be approached in their upbringing?

**Format:** Conditional scenario based choice

**Context note:** Expectations concerning a child's religious, spiritual, or nonreligious upbringing should be discussed and substantially agreed upon before making a long term parenting commitment.
...
**Alignment purpose:** Identifies expectations for belief formation, religious education, exposure, parental influence, and a child's developing autonomy.

### 10. Which faith, spiritual, or worldview related differences would most seriously threaten long term compatibility?
...
**Priority follow up:** Of the differences you selected, which two would be most difficult for you to move past?

**Alignment purpose:** Identifies essential belief boundaries and high impact incompatibilities without judging the respondent's religious or nonreligious identity.
...
Extended family boundaries remain primarily in Category 6.
Multiselect questions are not fully ranked. Only Q5, Q6, and Q10 receive a lightweight “choose the two most important” follow up.
...
Single choice: 1
Structured identity selection: 2
Select all that apply: 3
Importance scale: 4
Limited multiselect: 5, 6, 10
Flexibility range: 7
Scenario based choice: 8

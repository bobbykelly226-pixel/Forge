...
export const CATEGORY_07_PARENTING_ELIGIBILITY_ID = 'elig_parenting_role_c07';

export const CATEGORY_07_PARENTING_ELIGIBILITY = {
  id: CATEGORY_07_PARENTING_ELIGIBILITY_ID,
  ruleKey: 'parenting_role_display_c07',
  description:
...
export const CATEGORY_07_FORMAT_DISTRIBUTION = {
  'Single choice': [1],
...
const QUESTIONS: QuestionDefinition[] = [
  ...
  q({
    ...
    priorityFollowUp: {
      prompt: 'Of the conditions you selected, which two would be most necessary?',
      selectionCount: 2,
      unordered: true,
    },
  }),
  ...
  q({
    ...
    minSelections: 1,
    maxSelections: 1,
    eligibilityRuleId: CATEGORY_07_PARENTING_ELIGIBILITY_ID,
    conditional: {
      kind: 'conditional_scenario',
      requiresEligibilityRuleId: CATEGORY_07_PARENTING_ELIGIBILITY_ID,
    },
    contextNote:
...
export const CATEGORY_07: CategoryDefinition = {
  id: CATEGORY_KEY,
  number: 7,
  title: 'Faith, Spirituality & Worldview',
  status: 'locked',
  lockedProductDecisions: CATEGORY_07_LOCKED_PRODUCT_DECISIONS,

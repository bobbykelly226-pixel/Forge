...
const GROWING_ALIGNMENT = [
  ...
  },
  {
    ...
    copy: 'There are signs of alignment, though one or both profiles need additional answers.',
  },
] as const;
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain px-5 py-5 sm:px-6 sm:py-6">
          <p id={descriptionId} className="text-[15px] leading-relaxed text-[#3D4654]">
            Forge surfaced this profile because several meaningful areas of your lives appear to
            align.
          </p>
          <p className="mt-3 text-sm leading-relaxed text-[#7A8494]">
            This is guidance, not a prediction. Real compatibility grows through conversation, time,
          ...
          <section className="mt-7 rounded-[1.5rem] border border-[#0B2D5C]/08 bg-white/90 p-5 shadow-[0_8px_28px_rgba(11,45,92,0.05)]">
            ...
            <div className="mt-4 border-t border-[#0B2D5C]/06 pt-4">
              <p className="text-xs font-semibold uppercase tracking-[0.12em] text-[#7A8494]">
                Confidence
              </p>
              <p className="mt-1.5 text-base font-semibold text-[#0B2D5C]">Moderate</p>
            </div>
            <p className="mt-4 text-sm leading-relaxed text-[#5A6575]">
              Based on 18 shared answer areas
            </p>
          </section>
          ...
          <section className="mt-8" aria-labelledby="important-factor-heading">
            ...
            <div className="mt-4 rounded-[1.5rem] border-2 border-[#D62828] bg-[#FBF6EE] p-5 shadow-[0_8px_28px_rgba(214,40,40,0.08)]">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-base font-semibold text-[#0B2D5C]">Children</p>
                  <p className="mt-2 text-[15px] leading-relaxed text-[#3D4654]">
                    One profile currently indicates wanting children, while the other indicates not
                    wanting children.
                  </p>
                  <p className="mt-3 text-sm leading-relaxed text-[#5A6575]">
                    This does not determine whether a relationship can succeed. It is an important
                    difference worth understanding before moving forward.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="mt-8 rounded-[1.5rem] border border-[#0B2D5C]/08 bg-white/90 p-5">
            ...
            <p className="mt-4 text-xs font-semibold uppercase tracking-[0.12em] text-[#7A8494]">
              Current confidence
            </p>
            <p className="mt-1.5 text-base font-semibold text-[#0B2D5C]">Moderate</p>
            <p className="mt-4 text-sm leading-relaxed text-[#5A6575]">
              This introduction is based on 18 shared answer areas. Confidence can change as both
              people answer more compatibility questions.
            </p>
            <Link
              href="/onboarding"
          ...
          <p className="mt-8 text-center text-xs text-[#8A93A0]">
            Prototype only — guidance language, not live compatibility scoring.
          </p>
        </div>

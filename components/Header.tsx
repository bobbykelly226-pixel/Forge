  ...
  return (
    <nav className="border-b border-[#0B2D5C]/20 bg-[#0B2D5C] backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-8 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 sm:gap-12 text-sm sm:text-lg font-semibold text-white">
      ...
      {menuOpen && (
        <div className="md:hidden bg-[#0B2D5C] border-t border-white/20 py-4">
          <div className="flex flex-col text-center gap-4 text-lg font-semibold text-white">

alter table public.profiles add column education_other text;
alter table public.profiles add constraint education_other_length check (char_length(education_other) <= 200);
...
begin
 ...
 execute replace(source, 'favorite_music_songs = ', 'education_other = null, favorite_music_songs = ');
end;
$patch$;

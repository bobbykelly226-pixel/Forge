  ...
  return (
    <div className="min-h-screen bg-[#F8F6F2] text-[#222222]">
      ...
      <main className="pt-16 pb-20 max-w-2xl mx-auto px-5 sm:px-6 text-center">
        ...
        <div className="bg-white border border-[#0B2D5C]/10 rounded-3xl p-8 sm:p-10 shadow-sm mb-10 text-left sm:text-center">
          <h2 className="text-2xl font-bold tracking-tight text-[#0B2D5C] mb-3">
            Continue your Forge setup
          </h2>
          <p className="text-lg text-[#444444] leading-relaxed mb-8">
            Complete the first few steps so Forge can begin shaping a more intentional
            compatibility profile.
          </p>
          <div className="flex flex-col gap-3">
            <Link
              href="/onboarding"
              className="inline-flex w-full items-center justify-center bg-[#D62828] hover:bg-[#A61F1F] text-white px-8 py-4 rounded-2xl font-semibold text-lg transition"
            >
              Start Onboarding
            </Link>
            <Link
